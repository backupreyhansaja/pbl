...
<section class="py-16 bg-gray-50">
    <div class="max-w-6xl mx-auto px-4">
        <h1 class="text-4xl font-extrabold text-center text-purple-700 mb-3">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <?php foreach ($berita as $b): ?>
                <div class="bg-white rounded-2xl shadow-md overflow-hidden hover:shadow-xl transition">
                    <div class="h-40 bg-gradient-to-br from-purple-500 to-blue-500 flex items-center justify-center">
                    ...
                    <div class="p-6">
                        ...
                        <a href="news_detail.php?id=<?= $b['id']; ?>" 
                           class="text-purple-600 font-semibold hover:underline text-sm">
                            Baca Selengkapnya →
                        </a>
                    </div>
                </div>
        ...
        <div class="flex justify-center mt-12 space-x-2">
            ...
            <?php for ($i = 1; $i <= $totalPages; $i++): ?>
                <a href="?page=<?= $i ?>" 
                    ...
                    <?= $i == $page ? 'bg-purple-600 text-white' : 'bg-gray-200 text-gray-700 hover:bg-gray-300' ?>">
                    <?= $i ?>
                </a>
            <?php endfor; ?>
