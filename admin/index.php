    ...
    <div class="bg-white rounded-xl shadow-md p-4 md:p-6 hover:shadow-lg transition transform hover:scale-105 duration-200">
        <div class="flex items-center justify-between mb-3 md:mb-4">
            <div class="flex-1 min-w-0">
                <p class="text-gray-600 text-xs md:text-sm mb-1 truncate">Total Staff</p>
                <h3 class="text-2xl md:text-3xl font-bold text-gray-800"><?php echo $staffCount; ?></h3>
            </div>
            <div class="w-12 h-12 md:w-14 md:h-14 bg-blue-100 rounded-full flex items-center justify-center flex-shrink-0 ml-3">
                <i class="fas fa-user-tie text-blue-600 text-xl md:text-2xl"></i>
            </div>
        </div>
        <a href="staff.php" class="text-blue-600 text-xs md:text-sm inline-flex items-center hover:underline">
